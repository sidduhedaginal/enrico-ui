...
export class ImportFileComponent {
  ...
  constructor(
    ...
    private importdataService: ImportedDataService,
  ...
  Onsave() {
    ...
    this.apiService.postProcessImportFile(menuId[this.routerdata.title],insertAndUpdate,this.filename, this.importdataService.getBase64Format())
      .subscribe(
        (response: any) => {
  ...
  downloadTemplate() {
    ...
    let filename = '';
    this.loaderService.setShowLoading();
    this.apiService.postDownloadTemplate(menuId[this.routerdata.title])
      .subscribe(
        (response: any) => {
