...
@Component({
  ...
  template: '<mat-form-field appearance="fill"><mat-label>Choose a date</mat-label><input [(ngModel)]="inputDate" matInput [matDatepicker]="picker" />'+
...
export class MatDatePickerComponent implements ICellEditorAngularComp {
  ...
  onKeyDown(event:any): void {
    ...
    if (key == 9) {
      ...
      this.inputs.forEach((input: ViewContainerRef) => {
