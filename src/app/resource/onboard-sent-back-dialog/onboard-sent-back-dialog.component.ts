...
@Component({
  selector: 'app-onboard-sent-back-dialog',
  templateUrl: './onboard-sent-back-dialog.component.html',
  styleUrls: ['./onboard-sent-back-dialog.component.scss'],
})
export class OnboardSentBackDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OnboardSentBackDialogComponent>, @Inject(MAT_DIALOG_DATA) public _Data: any, private snackBar: MatSnackBar, private API: ApiResourceService,private router: Router,private fb: FormBuilder
  ) {
