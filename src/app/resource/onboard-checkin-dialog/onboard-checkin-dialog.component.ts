...
@Component({
  selector: 'app-onboard-checkin-dialog',
  templateUrl: './onboard-checkin-dialog.component.html',
  styleUrls: ['./onboard-checkin-dialog.component.scss'],
})
export class OnboardCheckinDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OnboardCheckinDialogComponent>, @Inject(MAT_DIALOG_DATA) public _Data: any, private snackBar: MatSnackBar, private API: ApiResourceService,private router: Router,private fb: FormBuilder
  ) { 
