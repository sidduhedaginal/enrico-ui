...
@Component({
  selector: 'app-onboard-issueid-card-dialog',
  templateUrl: './onboard-issueid-card-dialog.component.html',
  styleUrls: ['./onboard-issueid-card-dialog.component.scss'],
})
export class OnboardIssueidCardDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OnboardIssueidCardDialogComponent>, @Inject(MAT_DIALOG_DATA) public _Data: any, private snackBar: MatSnackBar, private API: ApiResourceService,private router: Router,
