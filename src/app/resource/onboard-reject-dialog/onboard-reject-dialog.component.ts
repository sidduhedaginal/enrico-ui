...
@Component({
  selector: 'app-onboard-reject-dialog',
  templateUrl: './onboard-reject-dialog.component.html',
  styleUrls: ['./onboard-reject-dialog.component.scss'],
})
export class OnboardRejectDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<OnboardRejectDialogComponent>, @Inject(MAT_DIALOG_DATA) public _Data: any, private snackBar: MatSnackBar, private API: ApiResourceService,private router: Router,private fb: FormBuilder
  ) { 
