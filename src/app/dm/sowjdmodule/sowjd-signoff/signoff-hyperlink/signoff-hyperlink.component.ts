...
@Component({
  selector: 'app-signoff-hyperlink',
  templateUrl: './signoff-hyperlink.component.html',
  styleUrls: ['./signoff-hyperlink.component.css'],
})
export class SignoffHyperlinkComponent {
  ...
  navigateToSowjdDetail(technicalproposalID: string) {
    this.router.navigate(['/sowjd/sowjd-signoff', technicalproposalID]);
  }
