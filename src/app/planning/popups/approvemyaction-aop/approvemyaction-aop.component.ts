...
@Component({
  selector: 'app-approvemyaction-aop',
  templateUrl: './approvemyaction-aop.component.html',
  styleUrls: ['./approvemyaction-aop.component.css']
})
export class ApprovemyactionAOPComponent {
  myForm!:FormGroup;
  receivedData: any;
  fileData!: string;
  EventFile: any;
  ...
  constructor(public dialogRef: MatDialogRef<ApprovemyactionAOPComponent>,
