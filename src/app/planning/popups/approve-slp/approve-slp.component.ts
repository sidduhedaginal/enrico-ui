...
@Component({
  selector: 'app-approve-slp',
  templateUrl: './approve-slp.component.html',
  styleUrls: ['./approve-slp.component.css']
})
export class ApproveSLPComponent {
  myForm!:FormGroup;
  receivedData: any;
  fileData!: string;
  EventFile: any;
  ...
  constructor(public dialogRef: MatDialogRef<ApproveSLPComponent>,
